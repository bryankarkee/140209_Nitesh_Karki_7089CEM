...
##setwd("C:/Users/nituk/OneDrive - Softwarica College/Block_1/Statistical_Methods_For_Data_Science")
##getwd()

# Importing X data and  reading dataset time and loading into data matrix
time_dataset = read.csv("time_1673241270748.csv")
...
# reading dataset X and loading into data matrix
 ...
 X_dataset <- read.csv("X_1673241366257.csv")
...
#reading dataset Y and loading into data matrix
 ...
 Y_dataset <- read.csv("y_1673241374123.csv")
...
plot(X.ts,main = "Time series plot of X Signal" ,xlab = "Time", ylab = "Input signal", col="Green",pch=20,cex=3)
plot(Y.ts,main = "Time series plot of Y Signal", xlab = "Time", ylab = "Output signal", col="Green",pch=20,cex=3)

##Task 1: Creating a density plot with the help of histogram
#Creating a density if X signal

dis=density(X_matrix)
plot(dis,main = "Density Plot of All Input Signal",col="Green",pch=20,cex=3)

# Creating a Histrogram of X signal
hist(X_matrix,freq = FALSE,main = "Density",col = "gray" ,xlab = "X")
lines(dis,lwd=2,col="Green")
rug(jitter(X_matrix),col="light blue")
...
rug(jitter(X_matrix[,"X1"]),col="light blue")
...
lines(dis_X2,lwd=2,col="Green")
rug(jitter(X_matrix[,"X2"]),col="light blue")
...
lines(dis_X3,lwd=2,col="Green")
rug(jitter(X_matrix[,"X3"]),col="light blue")
...
lines(dis_X1,lwd=2,col="Green")
rug(jitter(X_matrix[,"X4"]),col="light blue")

#Creating a density if Y signal
dis_y=density(Y_matrix)
plot(dis_y,main = "Density plot of Y",xlab = "Output Signal",col="Green",pch=20,cex=3)

hist(Y_matrix,freq = FALSE,main = "Histogram And Density Plot of Y",xlab = "Output Signal")
lines(dis_y,lwd=2,col="Green")
rug(jitter(Y_matrix),col="light blue")


## Task 1: Creating Correlation and Scatter plot.
# Plotting X1 against 
plot(X_matrix[,"X1"],Y_matrix,main = "Correlation betweeen X1 and Y signal", xlab = "X1 signal", ylab = "Outputsignal",col="Red",pch=20,cex=1)
# Plotting X2 against Y
plot(X_matrix[,"X2"],Y_matrix,main = "Correlation betweeen X2 and Y signal", xlab = "X2 signal", ylab = "Outputsignal",col="Red",pch=20,cex=1 )
# Plotting X3 against Y
plot(X_matrix[,"X3"],Y_matrix,main = "Correlation betweeen X3 and Y signal", xlab = "X3 signal", ylab = "Outputsignal",col="Red",pch=20,cex=1 )
# Plotting X4 against Y
plot(X_matrix[,"X4"],Y_matrix,main = "Correlation betweeen X4 and Y signal", xlab = "X4 signal", ylab = "Outputsignal",col="Red",pch=20,cex=1 )
...
{
print(paste("Mod1_thetahat",Mod1_thetahat[1]))
print(paste("Mod1_thetahat",Mod1_thetahat[2]))
print(paste("Mod1_thetahat",Mod1_thetahat[3]))
print(paste("Mod1_thetahat",Mod1_thetahat[4]))
print(paste("Mod1_thetahat",Mod1_thetahat[5]))
...
{
print(paste("Mod2_thetahat",Mod2_thetahat[1]))
print(paste("Mod2_thetahat",Mod2_thetahat[2]))
print(paste("Mod2_thetahat",Mod2_thetahat[3]))
print(paste("Mod2_thetahat",Mod2_thetahat[4]))
}
...
{
print(paste("Mod3_thetahat",Mod3_thetahat[1]))
print(paste("Mod3_thetahat",Mod3_thetahat[2]))
print(paste("Mod3_thetahat",Mod3_thetahat[3]))
}
...
{
print(paste("Mod4_thetahat",Mod4_thetahat[1]))
print(paste("Mod4_thetahat",Mod4_thetahat[2]))
print(paste("Mod4_thetahat",Mod4_thetahat[3]))
print(paste("Mod4_thetahat",Mod4_thetahat[4]))
}
...
{
print(paste("Mod5_thetahat",Mod5_thetahat[1]))
print(paste("Mod5_thetahat",Mod5_thetahat[2]))
print(paste("Mod5_thetahat",Mod5_thetahat[3]))
print(paste("Mod5_thetahat",Mod5_thetahat[4]))
print(paste("Mod5_thetahat",Mod5_thetahat[5]))
...
{
print(paste("RSS_Mod_1",RSS_Mod_1[1]))
print(paste("RSS_Mod_2",RSS_Mod_2[1]))
print(paste("RSS_Mod_3",RSS_Mod_3[1]))
print(paste("RSS_Mod_4",RSS_Mod_4[1]))
print(paste("RSS_Mod_5",RSS_Mod_5[1]))
}
...
likehood_Mod_1=-(N/2)*(log(2*pi))-(N/2)*(log(Var_modl1))-(1/(2*Var_modl1))*RSS_Mod_1
likehood_Mod_1
#Calculating Variance and log-likelihood of Model 2
Var_modl2=RSS_Mod_2/(N-1)
Var_modl2
likehood_Mod_2=-(N/2)*(log(2*pi))-(N/2)*(log(Var_modl2))-(1/(2*Var_modl2))*RSS_Mod_2
likehood_Mod_2
#Calculating Variance and log-likelihood of Model 3
Var_modl3=RSS_Mod_3/(N-1)
Var_modl3
likehood_Mod_3=-(N/2)*(log(2*pi))-(N/2)*(log(Var_modl3))-(1/(2*Var_modl3))*RSS_Mod_3
likehood_Mod_3
#Calculating Variance and log-likelihood of Model 4
Var_modl4=RSS_Mod_4/(N-1)
Var_modl4
likehood_Mod_4=-(N/2)*(log(2*pi))-(N/2)*(log(Var_modl4))-(1/(2*Var_modl4))*RSS_Mod_4
likehood_Mod_4
#Calculating Variance and log-likelihood of Model 5
Var_modl5=RSS_Mod_5/(N-1)
Var_modl5
likehood_Mod_5=-(N/2)*(log(2*pi))-(N/2)*(log(Var_modl5))-(1/(2*Var_modl5))*RSS_Mod_5
likehood_Mod_5

{print(paste("likehood_Mod_1",likehood_Mod_1[1]))
print(paste("likehood_Mod_2",likehood_Mod_2[1]))
print(paste("likehood_Mod_3",likehood_Mod_3[1]))
print(paste("likehood_Mod_4",likehood_Mod_4[1]))
print(paste("likehood_Mod_5",likehood_Mod_5[1]))}
...
BIC_mod5
{
print(paste("Akaike Information Criterion_mod1:   ",AIC_mod1[1]))
print(paste("Akaike Information Criterion_mod2    ",AIC_mod2[1]))
print(paste("Akaike Information Criterion_mod3    ",AIC_mod3[1]))
print(paste("Akaike Information Criterion_mod4    ",AIC_mod4[1]))
print(paste("Akaike Information Criterion_mod5    ",AIC_mod5[1]))
}

{
print(paste("Bayesian Information Criterion_mod1    ",BIC_mod1[1]))
print(paste("Bayesian Information Criterion_mod2    ",BIC_mod2[1]))
print(paste("Bayesian Information Criterion_mod3    ",BIC_mod3[1]))
print(paste("Bayesian Information Criterion_mod4    ",BIC_mod4[1]))
print(paste("Bayesian Information Criterion_mod5    ",BIC_mod5[1]))
}
...
p2 <- plot(density(Y_training_data), col="blue", lwd=2,main="Distribution of training Data")
...
thetebias <-  0.509231516833398 #choosen parameter
thetaone <- 0.0532387464436638 # chosen prarameter
thetatwo <- 0.0120672403454773 # constant value
thetafour <- -0.00185597488650918 # constant value
Epison <- RSS_Mod_4 * 2 ## fixing value of eplision
num <- 100 #number of iteration

##Calculating Y-hat for performing rejection ABC
counter <- 0
for (i in 1:num) {
range1 <- runif(1,-0.509231516833398,0.509231516833398) # calculating the range
range1
range2 <- runif(1,-0.0532387464436638,0.0532387464436638)
New_thetahat <- matrix(c(range1,range2,thetatwo,thetafour))
New_Y_Hat <- X_mod4 %*% New_thetahat ## New Y hat
...
# Create a random index for splitting the data into training and testing sets
index <- sample(1:n, size = round(0.7*n), replace = FALSE)

# Split the data into training and testing sets
X_train <- X_matrix[index, ]
y_train <- Y_matrix[index]
X_test <- X_matrix[-index, ]
y_test <- Y_matrix[-index]
print (X_train)
# Fit the model using the training data
model_fit <- lm(y_train ~ poly(X_train, degree = 2, raw = TRUE))

# Predict the output using the fitted model on the test data
y_pred <- predict(model_fit, newdata = X_test)

# Compute the 95% confidence intervals for the predictions
conf_int <- predict(model_fit, newdata = X_test, interval = "confidence")
...
plot_data <- data.frame(y_test, y_pred,
                        lower = conf_int[,2],
                        upper = conf_int[,3])

# Plot the data using ggplot2
ggplot(plot_data, aes(x = y_test)) +
  geom_point(aes(y = y_pred), color = "red") +
  geom_errorbar(aes(ymin = lower, ymax = upper), color = "blue", width = 0.2) +
  labs(x = "Testing Data", y = "Model Prediction")
